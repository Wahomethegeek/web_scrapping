...
allowed_emails = [
                  "eedwardeparks@gmail.com"
                  ]
while True:
    email = input("Input your verbit email address: ").lower().strip()
...
class Email_Sender():
    def __init__(self, user):
        ...
        self.email_reciever = "thegeekwahome@gmail.com"
...
while True:
    ...
    refresh_time = float("%.2f"%(2.0))
    time.sleep(refresh_time)
    myurl = driver.current_url
    try:
        user = driver.find_element(By.XPATH,"//*[@id=\"content-wrapper\"]/header/ul/li[6]/span/a")
